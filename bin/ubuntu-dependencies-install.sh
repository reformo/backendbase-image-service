apt-get install build-essential webp pngquant optipng pngcrush jpegoptim gifsicle libwebp-dev libheif-dev libjpeg-dev libpng-dev libopenjp2-7-dev libjxr-dev
...
cp /etc/php/8.1/fpm/conf.d/20-imagic.ini /etc/php/8.1/cli/conf.d/20-imagic.ini
cd ..
rm -rf imagick-*
